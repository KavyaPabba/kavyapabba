...
import { supabase } from "@/lib/supabaseclient"; // ⬅️ your supabase client
...
const ContactMinimal = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.from("contact_attempt").insert([
      {
        name: formData.name,
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ...
            how we can drive your business forward with AI and analytics.
          </p>
        </motion.div>
